...
# Or, supplying our own properDivisors function, and defining the harvest in
# terms of a generic concatMap:
...
def amicablePairsUpTo(n):
    """List of all amicable pairs of integers below n."""
...
# concatMap :: (a -> [b]) -> [a] -> [b]
def concatMap(f):
    """A concatenated list or string over which a function f has been mapped.
    The list monad can be derived by using an (a -> [b]) function which
    wraps its output in a list (using an empty list to represent
