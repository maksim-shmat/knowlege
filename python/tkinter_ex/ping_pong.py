...
# It is not work, check github pingpong with classes

from tkinter import *

WIDTH = 900    # global variable for setting window
HEIGHT = 300
...
# Make ball to move
# Add global variable for ball speed

BALL_X_CHANGE = 20    # to horizontal
BALL_Y_CHANGE = 0     # to vertical

# ==============================

# Move pads
# Add global var speed move pads
