...
def request_count():
    '''Request user input between 1, 2 and 3. It will continue till
    either quit(q) or one of those numbers is requested.'''
    t=""
    while True:
        try:
...
while r:
    ...
    if o == -1:
        ...
        c += 1 if o == 0 else 0
        m += 1 if o == 1 else 0
    print("Computer wins {0} game, leather_bag wins {1} games".format(c, m))
