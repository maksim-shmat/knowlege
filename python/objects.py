"""The squish game objects (objects.py). This module contains the game
objects of the Squish game."""
...
class SquishSprite(pygame.sprite.Sprite):
    ...
    """
    Generic superclass for all sprites in Squish. The constructor takes care of
    loading an image, setting up the sprite rect, and the area within which it
    is allowed to move. That area is governed by the screen size and the margin.
    """
...
class Weight(SquishSprite):
    """
    A falling weight. It uses SquishSprite constructor to set up
    it's weight image, and will fall with a speed given as a paramete
    to its constructor.
    """
    ...
    def reset(self):
        ...
        and place it at random horizontal position.
        """
...
class Banana(SquishSprite):
    """
    A desperate banana. It uses the SquishSprite constructor to set up it's
    banana image, and will stay near the bottom of the screen,
    ...
    def update(self):
        ...
        x-coordinate, adn then use the rect method clamp to ensure
    ...
    def touches(self, other):
        ...
        new rectange is first calculated (using the rect method
        ...
        # Move the bounds so they are placed at the bottom of the Bannana:
