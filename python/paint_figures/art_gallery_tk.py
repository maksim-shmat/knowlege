""" A small art gallery is selling works from different artists and want to
...
GUI. Bellow is the current data that needs to be stored in a database.
...
Once a piece of art has been sold, the data about that art should be removed
from the main SQL database and stored in a separate text file.
Users should be able to search be artist, medium or price.
"""
import sqlite3
from tkinter import *
...
artisttownlbl.place(x = 590, y = 40, width = 100, height = 25)
...
addbtn = Button(text = "Clear Artist", command = clearartist)
...
searchartistbtn = Button(text = "Search by Arist", command = searchartistoutput)
...
soldpiece.place(x = 1020, y = 450, width = 500, height = 25)
