...
canvas = Canvas(width=525, height=300, bg='orange')
...
canvas.create_rectangle(200, 200, 300, 300, width=5, fill='magenta')
canvas.create_line(0, 300, 150, 150, width=10, fill='brown')

photo=PhotoImage(file='herus.png')
