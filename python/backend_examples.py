...
# 116
# Import the data from the Books.csv file into a list. Display the list to
# the user. Ask them to select which row from the list they want to delete
# and allow them to change it. Write the data bach to the original .csv file,
...
# asked, their answers and their find score in a .csv file. Whenever the
# program is run it should add to the .csv file and not overwrite anything.
...
def first_guess():
    ...
    guess = int(input("Want am I thinking of: "))
    return guess
