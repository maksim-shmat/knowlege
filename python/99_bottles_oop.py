"""Frlexible, OOP, multiporcessing version 99 bottles.
...
4. when you lanunch it as a script, you can cpecify an optional parameter for
...
def main(num):
    ...
    print()
    print()
    print('### "The Ballad of Programmer" ###')
    print()
...
if __name__ == "__main__":
    ...
    if len(argv) == 1:
        ...
        try:
            ...
            raise ValueError(
                    f"{__file__} parameter must be an integer, or can be ommitted"
            )
    else:
