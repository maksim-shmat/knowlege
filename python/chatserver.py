...
class LoginRoom(Room):
    """
    A room meant fora single person who has just connected.
    """
    ...
    def unknown(self, session, cmd):
        # all unknown commands (anything except login of logout)
...
class ChatRoom(Room):
    """
    A room meant for multiple users who can chat with the others in the
    room.
    """
