"""4 square game with generators and without itertools."""
...
a = foursquares(1, 7, True, True)
print(a)

ab = foursquares(3, 9, True, True)
print(ab)

abc = foursquares(0, 9, False, False)
print(abc)
