"""Functional, pythonic version 99 bottles."""
...
def beer_song(
    ...
    :param distibution: specifies the process of its distribution
    :param solution: what happens when we run out of drinks
    :param container: bottle/barrel/flask or other conatiners
...
def get_verse(
    ...
    """Return teh verse for the given amount of drinks."""
    asset = partial(
            get_asset,
            container = container,
            plurifier = plurifier,
...
def get_inventory(
    ...
    >>> get inventory("10 bottles of beer", location="on the wall")
