...
proper divisors: deficient, perfect and abundant.
"""
...
# and the main functio could be rewritten in terms of an nthArrow abstraction
def nthArrow(f):
    """ A simple function lifted to one which applies to a tuple,
    transforming only it's nth value.
    """
    def  go(v, n):
        m = n - 1
