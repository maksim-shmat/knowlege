"""More examples for 24-game Gods of examples.

Given any four digits in the range 1 to 9, which may have repetitions,
using just the +, -, *, and / operators: and the possible use of brackets,
(), show how to make an answer of 24.

An answer of 'q' will quit the game.
An answer of '!' will generate a new set of four digits.
An answer of '!!' ask you for a new set of four digits.
An answer of '?' will compute an expression for the current digits.

Otherwise you are repeatedly asked for an expression until it evaluates,
...
def solve(digits):
    ...
    for d in digiperm:
        for ops in opcomb:
            if '/' in ops:
                d2 = [('F(%s)' % i) for i in d] # Use Fracions for accuracy
            else:
                d2 = d
