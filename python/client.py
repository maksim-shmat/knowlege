"""A Node controller intervace (client.py), for (server.py)."""

# python3 client.py urls.txt directory http://servername.com:4242
...
class Client(Cmd):
    ...
    def __init__(self, url, dirname, urlfile):
        """
        Sets the url, dirname, and urlfile, and start the Node
