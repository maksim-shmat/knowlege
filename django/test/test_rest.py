...
#3 files with tests needed:
* named tests.py
* name starts with the test_ prefix
* name ends with the _tests suffix

#4 pytest.ini

[pytest]
DJAGO_SETTINGS_MODULE = restful01.settings
...
class DroneCategoryTests(APITestCase):
    ...
    def test_filter_drone_category_by_name(self):
        """
        Ensure we cat filter a drone category by name
        """
...
class PilotTests(APITestCase):
    ...
    def test_try_to_post_pilot_without_token(self):
        ...
        new_pilot_name = 'Unauthorithed Pilot'
