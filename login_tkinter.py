...
def register_user():
    ...
    file.close()
    Label(screen1, text="registration success", font = "orange", height='2',
            width='30').pack()
...
def register():
    ...
    username = StringVar()
    password = StringVar()
    Label(screen1, text="please enter the given information", height='2', 
            width='30')
    ...
    password_entry.pack()
    Label(screen1, text="", height='2', width='30').pack()
    Button(screen1, text="submit", height="2", width='30',
...
def login():
    ...
    screen2.title("login")
    Label(screen2, text="Please enter the information for login", height='2',
            width='30').pack()
    ...
    Label(screen2, text="", height='2', width='30').pack()
    Button(screen2, text="login", height='2', width='30',
...
def main_screen():
    ...
    Button(text="Login", height='2', width='30', bg='purple',
            command = login).pack()
    Label(text="", height='2', width='30').pack()
    Button(text="register", height='2', width='30', bg='orange',
